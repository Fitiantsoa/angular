...
@Component({
  selector: 'app-create-produit-potager',
  templateUrl: './create-produit-potager.component.html',
  styleUrls: ['./create-produit-potager.component.css']
})
export class CreateProduitPotagerComponent implements OnInit {
