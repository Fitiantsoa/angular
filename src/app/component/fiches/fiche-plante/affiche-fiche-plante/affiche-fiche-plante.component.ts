...
@Component({
  selector: 'app-affiche-fiche-plante',
  templateUrl: './affiche-fiche-plante.component.html',
  styleUrls: ['./affiche-fiche-plante.component.css']
})
export class AfficheFichePlanteComponent implements OnInit {
