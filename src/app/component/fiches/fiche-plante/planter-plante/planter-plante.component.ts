...
@Component({
  selector: 'app-planter-plante',
  templateUrl: './planter-plante.component.html',
  styleUrls: ['./planter-plante.component.css']
})
export class PlanterPlanteComponent implements OnInit {
